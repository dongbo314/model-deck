...
4. Create ZIP and tar.gz archives directly from the tagged Git tree.
5. Generate a per-file manifest and SHA-256 checksums.
6. Extract the tar.gz into a clean directory, install from `package-lock.json`, rebuild and rerun the full-stack smoke test before publishing the prerelease.
